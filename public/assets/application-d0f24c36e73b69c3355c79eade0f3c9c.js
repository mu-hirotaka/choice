...
(function() {
  $(function() {
    $('#left-choice-btn').click(function() {
      var data, l_character_id, quest_id, r_character_id;
      ...
      data = {
        quest_id: quest_id,
        l_character_id: l_character_id,
        r_character_id: r_character_id
      };
      return $.ajax('/choice/choice', {
        type: 'GET',
        dataType: 'json',
        data: data,
    ...
    $('#right-choice-btn').click(function() {
      var data, l_character_id, quest_id, r_character_id;
    ...
    $('#left-modal-done-btn').click(function() {
      var l_character_id, quest_id;
      quest_id = $('#left-choice-btn').attr('data-quest-id');
      l_character_id = $('#left-choice-btn').attr('data-character-id');
      return location.href = '/choice/done?qid=' + quest_id + '&cid=' + l_character_id;
    });
    $('#right-modal-done-btn').click(function() {
      var quest_id, r_character_id;
      quest_id = $('#right-choice-btn').attr('data-quest-id');
      r_character_id = $('#right-choice-btn').attr('data-character-id');
      return location.href = '/choice/done?qid=' + quest_id + '&cid=' + r_character_id;
    });
    return $('#other-result-btn').click(function() {
      var quest_id;
      quest_id = $('#right-choice-btn').attr('data-quest-id');
      return location.href = '/choice/show_others?qid=' + quest_id;
    });
  });
